...
<body>
    ...
    <link rel="stylesheet" href="src/includes/css/master.css">
    ...
    <form action="includes/loguear.php" method="POST">
        <div class="Login">
            ...
            <div class="col text-center">
                <a href="includes/registro.php" class="btn btn-success btn-lg " role="button"
                    aria-disabled="true">Registrar</a>
            </div>
        </div>
    </form>
